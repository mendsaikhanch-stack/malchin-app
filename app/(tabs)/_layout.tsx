...
const hiddenTabs = ['explore', 'weather', 'ai-advisor', 'livestock', 'finance', 'diagnose', 'knowledge', 'funfacts', 'shinjikh', 'pasture', 'breeding', 'health', 'scanner', 'household', 'map-view', 'insurance'];
