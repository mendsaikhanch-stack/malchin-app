...
export const UI_ICON: Record<string, MCIName> = {
  ...
  '🟢': 'circle', '🔴': 'circle', '🟠': 'circle', '❓': 'help-circle-outline',
  // Нэмэлт (2-р шат — бүх үлдсэн emoji)
  '🏪': 'storefront-outline', '🏢': 'office-building-outline',
  '📡': 'satellite-variant', '🗺️': 'map-outline', '🗺': 'map-outline',
  '🌳': 'tree-outline', '🌲': 'pine-tree', '🏜️': 'image-filter-hdr', '🏜': 'image-filter-hdr',
  '👴': 'account-tie-outline', '👨‍⚕️': 'doctor', '🧑‍⚕️': 'doctor',
  '💾': 'content-save-outline', '📤': 'share-variant-outline', '📥': 'inbox-arrow-down',
  '📭': 'inbox-outline', '📬': 'inbox-outline',
  '🔥': 'fire', '♂️': 'gender-male', '♂': 'gender-male', '♀️': 'gender-female', '♀': 'gender-female',
  '▲': 'chevron-up', '▼': 'chevron-down', '◀': 'chevron-left', '▶': 'chevron-right',
  'ℹ️': 'information-outline', 'ℹ': 'information-outline',
  '🔔': 'bell-outline', '🚶': 'walk', '🎒': 'bag-personal-outline',
  '💹': 'chart-line', '📣': 'bullhorn-outline', '📢': 'bullhorn-outline',
  '👉': 'hand-pointing-right', '⛅': 'weather-partly-cloudy',
  '☁️': 'weather-cloudy', '☁': 'weather-cloudy', '🌧️': 'weather-rainy', '🌧': 'weather-rainy',
  '🌨️': 'weather-snowy', '🌨': 'weather-snowy', '🌬️': 'weather-windy', '🌬': 'weather-windy',
};
