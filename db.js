...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS vaccination_schedule (
    ...
    recommended_month TEXT NOT NULL,
    repeat_interval TEXT DEFAULT 'yearly',
  ...
  -- Бүртгэл: Мал чип
  CREATE TABLE IF NOT EXISTS animal_chips (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
...
const vsCount = db.prepare("SELECT COUNT(*) as cnt FROM vaccination_schedule").get();
if (vsCount.cnt === 0) {
  const v = db.prepare("INSERT INTO vaccination_schedule (animal_type, vaccine_name, disease, recommended_month, repeat_interval, age_requirement, notes, is_mandatory) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
  // Хонь
  v.run("sheep", "Шүлхий вакцин", "Шүлхий", "3,9", "6 months", "3 сараас дээш", "Жилд 2 удаа заавал", 1);
  v.run("sheep", "Цэцэг вакцин", "Хонины цэцэг", "4", "yearly", "2 сараас дээш", "Хавар хийлгэнэ", 1);
  v.run("sheep", "Боом вакцин", "Боом", "9", "yearly", "3 сараас дээш", "Намар хийлгэнэ", 1);
  v.run("sheep", "Хорхойн эм", "Дотрын хорхой", "4,7,10", "3 months", "1 сараас дээш", "Жилд 3-4 удаа", 0);
  v.run("sheep", "Бруцеллёзын шинжилгээ", "Бруцеллёз", "5", "yearly", "6 сараас дээш", "Жил бүр заавал", 1);
  // Ямаа
  v.run("goat", "Шүлхий вакцин", "Шүлхий", "3,9", "6 months", "3 сараас дээш", "", 1);
  v.run("goat", "PPR вакцин", "PPR", "4", "yearly", "4 сараас дээш", "Хавар хийлгэнэ", 1);
  v.run("goat", "Хорхойн эм", "Дотрын хорхой", "4,7,10", "3 months", "1 сараас дээш", "", 0);
  v.run("goat", "Цэцэг вакцин", "Ямааны цэцэг", "4", "yearly", "2 сараас дээш", "", 1);
  // Үхэр
  v.run("cattle", "Шүлхий вакцин", "Шүлхий", "3,9", "6 months", "3 сараас дээш", "", 1);
  v.run("cattle", "Сүрьеэ шинжилгээ", "Сүрьеэ", "5", "yearly", "6 сараас дээш", "Заавал", 1);
  v.run("cattle", "Бруцеллёзын шинжилгээ", "Бруцеллёз", "5", "yearly", "6 сараас дээш", "", 1);
  v.run("cattle", "Хорхойн эм", "Дотрын хорхой", "4,10", "6 months", "1 сараас дээш", "", 0);
  v.run("cattle", "Бабезиозын вакцин", "Бабезиоз", "5", "yearly", "6 сараас дээш", "Хачигт бүс нутагт", 0);
  // Адуу
  v.run("horse", "Ямын шинжилгээ", "Ям", "5", "yearly", "1 наснаас", "Маллеин сорил", 1);
  v.run("horse", "Томууны вакцин", "Адууны томуу", "9", "yearly", "6 сараас дээш", "", 0);
  v.run("horse", "Хорхойн эм", "Дотрын хорхой", "4,10", "6 months", "2 сараас дээш", "", 0);
  v.run("horse", "Тэмбүүний эмчилгээ", "Тэмбүү", "6", "yearly", "Бүгд", "Хачигт бүс нутагт", 0);
  // Тэмээ
  v.run("camel", "Цэцэг вакцин", "Тэмээний цэцэг", "4", "yearly", "3 сараас дээш", "", 1);
  v.run("camel", "Хорхойн эм", "Дотрын хорхой", "4,10", "6 months", "2 сараас дээш", "", 0);
}

// Seed guides
const guideCount = db.prepare("SELECT COUNT(*) as cnt FROM guides").get();
if (guideCount.cnt === 0) {
  const g = db.prepare("INSERT INTO guides (category, title, summary, content, steps, materials, estimated_cost, duration, season, emoji, tags) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

  // Өвөлжөө барих
  g.run("shelter", "Хонины хашаа барих", "50-100 хонинд зориулсан дулаан хашаа", "Хонины хашаа нь салхи, хүйтнээс хамгаалж, малын эрүүл мэндийг хадгалах зорилготой.",
    "1) Газар сонгох - хойд талаараа уул/толгодтой, өмнөд нээлттэй\n2) Суурь тавих - 8x12м хэмжээтэй, 30см гүнд\n3) Хана босгох - модон хүрээ, 2м өндөр\n4) Дулаалга - шавар+өвс холимог, 15см зузаан\n5) Дээвэр - модон хүрээ + төмөр хуудас\n6) Хаалга - өмнөд талд, 2м өргөн\n7) Агааржуулалт - дээвэрт жижиг цонх\n8) Шал - шороон шал, 10см өвс дэвсэх",
    "Мод (8м x 20ш), Төмөр хуудас (20м²), Шавар, Өвс, Хадаас, Хаалга, Сараалж",
    "₮800,000 - 1,500,000", "7-14 өдөр", "summer", "🏠", "хашаа,хонь,барилга");

  g.run("shelter", "Үхрийн хашаа + сааль байр", "10-20 үхэрт зориулсан хашаа, сааль хэсэгтэй", "Үхрийн хашаа нь хонины хашаанаас илүү том, бат бөх байх шаардлагатай.",
    "1) Газар - хуурай, ус зайлуулалт сайтай\n2) Хэмжээ - нэг үхэрт 6м² (нийт 10x12м)\n3) Суурь - чулуун суурь, 50см гүн\n4) Хана - мод/тоосго, 2.5м өндөр\n5) Сааль хэсэг - тусдаа 3x4м өрөө\n6) Тэжээлийн онгоц - урд талд, 60см өндөр\n7) Усны сав - автомат усалгаатай бол хамгийн сайн\n8) Шал - бетон шал (цэвэрлэхэд хялбар)",
    "Мод, Тоосго/блок, Цемент, Төмөр хуудас, Тэжээлийн онгоц, Усны сав",
    "₮2,000,000 - 4,000,000", "14-21 өдөр", "summer", "🐄", "хашаа,үхэр,сааль");

  g.run("shelter", "Адууны хашаа + сарай", "Адуунд зориулсан задгай + бүрхэвчтэй хашаа", "Адуу хүйтэнд тэсвэртэй боловч шуурга, цасанд хамгаалалт хэрэгтэй.",
    "1) Задгай хашаа - нэг адуунд 10м², 1.5м өндөр\n2) Бүрхэвчтэй хэсэг - адуу бүрт 5м²\n3) Хашаа - модон сараалж, бат бэхэлгээтэй\n4) Хаалга - 3м өргөн (адуу орж гарахад)\n5) Усны сав - том хэмжээтэй\n6) Шал - хайрга + шороо",
    "Модон сараалж, Төмөр утас, Төмөр хуудас (бүрхэвчинд), Хаалга",
    "₮500,000 - 1,000,000", "5-10 өдөр", "summer", "🐴", "хашаа,адуу");

  // Тэжээл тарих
  g.run("feed", "Тэжээлийн өвс тарих", "Малд зориулсан өвс тариалах заавар", "Хадлангийн өвс тариалж, өвлийн тэжээлийн хангамжийг нэмэгдүүлнэ.",
    "1) Газар сонгох - услалтын боломжтой, тэгш газар\n2) Газар хагалах - 5-р сарын эхээр\n3) Үрийг тарих - 1 га-д 20-25 кг үр\n4) Услах - долоо хоногт 1-2 удаа\n5) Бордох - тарьсны дараа 30 хоногт\n6) Хураах - 7-8 сард, цэцэглэж дуусахад\n7) Хатаах - 3-5 өдөр наранд хатаах\n8) Боох - боодол болгож хадгалах",
    "Өвсний үр (люцерна, тэжээлийн будаа), Бордоо, Услалтын хоолой",
    "₮200,000 - 500,000 /га", "4-5 сар (5-9 сар)", "spring", "🌾", "тэжээл,өвс,тариалалт");

  g.run("feed", "Тэжээлийн ургамал тарих", "Арвай, овъёос зэрэг тэжээлийн ургамал", "Тэжээлийн үр тариа малын өвлийн тэжээлд нэн чухал.",
    "1) Сорт сонгох - арвай (богино хугацаанд ургана)\n2) Газар бэлтгэх - 5-р сарын эхээр хагалах\n3) Тарих - 5-р сарын дунд үеэс\n4) Нэг га-д 150-180 кг үр\n5) Услалт - ургалтын үед 2-3 удаа\n6) Хураалт - 8-9 сард ногоон байхдаа хурааж силос хийх\n7) Хадгалалт - сүүдэр, хуурай газар",
    "Арвайн үр, Овъёосны үр, Бордоо, Тариалангийн багаж",
    "₮300,000 - 800,000 /га", "3-4 сар", "spring", "🌱", "тэжээл,арвай,тариалалт");

  g.run("feed", "Силос бэлтгэх", "Ногоон тэжээлийг силосолж хадгалах", "Силос нь ногоон тэжээлийг исгэж хадгалсан бөгөөд өвөлдөө шимт тэжээл болно.",
    "1) Силосын нүх ухах - 2x3x1.5м (5-10 тонн)\n2) Нүхний ёроолд целлофан дэвсэх\n3) Ногоон ургамлыг жижиглэх (3-5 см)\n4) Давхарлан дарах (20-30 см тутамд)\n5) Давс нэмэх (1 тонн тэжээлд 5 кг)\n6) Сайн нягтруулах (агаар гаргах)\n7) Целлофаноор бүрэх\n8) Газар, чулуугаар дарах\n9) 3-4 долоо хоногт бэлэн болно",
    "Целлофан, Давс, Ногоон ургамал, Багаж",
    "₮100,000 - 200,000", "1 өдөр бэлтгэл + 3-4 долоо хоног исгэлт", "autumn", "🥬", "силос,тэжээл,хадгалалт");

  // Чип бүртгэл заавар
  g.run("tech", "Малд смарт чип суулгах", "RFID/GPS чипээр мал бүртгэх заавар", "Смарт чип нь малыг цахим бүртгэлд оруулж, алдагдал, хулгайнаас хамгаална.",
    "1) Чипний төрөл сонгох:\n   - RFID чих тэмдэг (₮3,000-5,000/ш) - хямд\n   - RFID имплант (₮8,000-15,000/ш) - бат бөх\n   - GPS трекер (₮50,000-100,000/ш) - байршил\n2) Малын эмчээр суулгуулах\n3) Чих тэмдэг: чихний дунд хэсэгт\n4) Имплант: хүзүүний зүүн талд арьс доор\n5) Бүртгэл: апп-д чипний дугаар, малын мэдээлэл оруулах\n6) Уншигч төхөөрөмжөөр шалгах",
    "RFID чих тэмдэг/имплант, Уншигч төхөөрөмж (₮150,000-300,000), Ариутгагч",
    "₮3,000-100,000 /мал", "10-15 мин /мал", "", "📱", "чип,RFID,GPS,бүртгэл");

  // Худаг
  g.run("water", "Гар худаг ухах", "Гар аргаар 5-15м гүн худаг ухах", "Бэлчээрийн ойролцоо худаг ухаж малын усны хангамж сайжруулна.",
    "1) Газар сонгох - ургамал ногоон, намхан газар\n2) Тагнуул хийх - усны түвшин тодорхойлох\n3) Нүх ухах - 1м диаметр, чулуу бүрэлдэхүүнээс хамааран\n4) Ханыг бэхлэх - бетон цагираг/чулуу\n5) Усны түвшинд хүрэх (5-15м)\n6) Шүүлтүүр тавих - хайрга, элс\n7) Тагтай болгох - бохирдлоос хамгаалах\n8) Помп суурилуулах - гар/нарны помп",
    "Бетон цагираг, Хайрга, Элс, Помп, Таг, Хүрз, Хөшүүрэг",
    "₮500,000 - 2,000,000", "3-7 өдөр", "summer", "💧", "худаг,ус,ухах");

  // Газрын бүртгэл
  g.run("legal", "Газрын гэрчилгээ авах", "Бэлчээр, өвөлжөөний газрын эзэмшлийн гэрчилгээ", "Газрын эзэмшлийн гэрчилгээ нь малчны эрхийг хамгаалж, зээл авахад барьцаа болно.",
    "1) Сумын газрын албанд хүсэлт өгөх\n2) Шаардлагатай бичиг баримт:\n   - Иргэний үнэмлэх\n   - Өрхийн бүртгэл\n   - Малын тооны лавлагаа\n   - Газрын зураг\n3) Газрын хэмжилт хийлгэх\n4) Кадастрын зурагт оруулах\n5) Газрын алба шийдвэр гаргах (30 хоног)\n6) Гэрчилгээ авах\n7) Хугацаа: 15-60 жил",
    "Иргэний үнэмлэх, Өрхийн бүртгэл, Малын тооны лавлагаа, Газрын хэмжилтийн зураг",
    "₮20,000 - 50,000 (хэмжилт)", "30-60 өдөр", "", "📜", "газар,гэрчилгээ,эзэмшил");
}
