# AGENTS.md — Malchin Super App

Энэ файл нь Codex болон бусад AI-д зориулсан **locked project context** юм.
...
- Дэлгэрэнгүй мастер баримт: [PRD.md](./PRD.md)
- Memory (user preferences): `~/.Codex/projects/C--Users-MNG-malchin-app/memory/`
