...
>
> Frontend: commit `add1108` үеийн төлөв.
> Backend: `api.malchin.mn` (REST, 40+ endpoints аль хэдийн бий).
...
- **Seasonal байршил upload** — `userApi.create({ seasonal })` `any` param-ээр
  ...
  буй эсэхийг шалгах.
- **Onboarding re-fetch** — сүүлийн commit (cb336a0)-д backend унасан үед
  AsyncStorage fallback хийх логик нэмэгдсэн ✓. Backend эрүүл бол pristine
  flow хэвээр.
