...
|---|---|---|
| Additional gating wiring | `<FeatureGate>` + `<UpgradePrompt>` component бэлэн. sum-dashboard heatmap `sum_dashboard_full`-ээр gated | Premium сонирхолтой бусад screen-д гэхэд advisory unlimited, listings_create_unlimited-д cap enforcement |
