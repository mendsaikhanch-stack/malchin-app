...
|---|---|---|
| Pricing route guards | `/pricing` screen + `usePackage()` + profile link wired | Per-feature route guard (advisory unlimited, sum_dashboard_full гэх мэт) — UI-д премиум шаардсан feature-д upgrade prompt |
