...
|---|---|---|
| — | Advisory 3/сар + listings 3 active cap бүгд wired (341 тест). Market-д "+ Шинэ зар нэмэх" button-д quota banner + cap reached alert + /pricing CTA | (дууссан) |
...
| — | Elder capability opt-in + disable бүгд UI-д wired. "Capability-г унтраах" button elder-content screen-ий доод хэсэгт, confirm alert-тай (6 test) | (дууссан) |
